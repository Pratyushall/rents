  ...
  const getNavigationItems = () => {
    const baseItems = [
      ...
      },
      {
        ...
        badge: messages > 0 ? messages : null,
      },
      {
        name: "Notifications",
    ...
    const roleSpecificItems = {
      tenant: [
        ...
        {
          name: "Certificates",
          href: `/dashboard/tenant/certificates`,
          icon: (
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      landlord: [
        ...
        {
          name: "Certificates",
          href: `/dashboard/landlord/certificates`,
          icon: (
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      manager: [
        ...
        {
          name: "Disputes",
          href: `/dashboard/manager/disputes`,
          icon: (
            <svg
              className="w-5 h-5"
              fill="none"
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <Link href="/" className="text-2xl font-extra-bold">
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`flex items-center px-3 py-2 text-sm font-bold rounded-md transition-colors ${
                    isActive
